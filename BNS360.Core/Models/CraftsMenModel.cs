...
namespace BNS360.Core.Models
{
    public class CraftsMenModel
    {
        ...
        public string CraftsMenNameArabic { get; set; } = string.Empty;
        public string? CraftsMenNameEnglish { get; set; }
        public string CraftsMenDescriptionArabic { get; set; } = string.Empty;
        public string? CraftsMenDescriptionEnglish { get; set; }
        public string CraftsMenAddressArabic { get; set; } = string.Empty;
